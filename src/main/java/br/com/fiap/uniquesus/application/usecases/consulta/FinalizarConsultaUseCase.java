...
public class FinalizarConsultaUseCase
{
    ...
    public FinalizarConsultaUseCase ( ConsultaGateway consultaGateway , AtendimentoGateway atendimentoGateway , MedicoGateway medicoGateway , PacienteGateway pacienteGateway )
    {
    ...
    public Consulta executar ( Long consultaId, String diagnostico )
    {
        ...
        consultaEncontrada.finalizarConsulta(diagnostico);
        
        Consulta consultaFinalizada = this.consultaGateway.gravarConsulta( consultaEncontrada );
        
        consultaFinalizada.setAtendimento( atendimentoEncontrado );
        consultaFinalizada.setMedico( medicoEncontrado );
